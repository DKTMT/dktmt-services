"""
Django settings for predict_service project.
...
APP_SECRET = os.environ.get("PREDICT_SERVICE_APP_SECRET")
DB_HOST = os.environ.get("PREDICT_SERVICE_DB_HOST")
DB_PORT = os.environ.get("PREDICT_SERVICE_DB_PORT")
...
MIDDLEWARE = [
    ...
    "predict_service.middleware.OAuthValidationMiddleware",
]
